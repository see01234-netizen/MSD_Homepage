    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-800 px-4">
      <div className="max-w-md w-full bg-gray-700 rounded-xl shadow-2xl border border-gray-600 p-10 overflow-hidden relative">
        ...
        <div className="text-center mb-10">
          <h2 className="text-3xl font-black text-gray-100 tracking-tighter mb-2">ADMIN ACCESS</h2>
          <p className="text-gray-300 text-sm">사업실적 관리를 위한 관리자 인증</p>
        </div>
